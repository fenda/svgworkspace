...
| `messy.svg` | Realistic bad SVG fixture with multiple structural, performance, and color issues. | `Missing viewBox`, `Fixed Width & Height`, `Metadata Found`, `Comments Found`, `High Decimal Precision`, `Hardcoded Fill Colors`, `Hardcoded Stroke Colors` |
