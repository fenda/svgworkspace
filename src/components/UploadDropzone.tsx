...
export function UploadDropzone() {
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        "flex h-full min-h-[280px] flex-col items-center justify-center rounded-2xl border border-dashed bg-[#111114] p-8 text-center transition-all duration-150 outline-none",
